    ...
    <div className='flex flex-col md:flex-row lg:flex-row justify-between pl-8'>
      ...
      <div>
        <div className='flex-col md:flex-row lg:flex-row gap-[8px] pb-4 pr-12 '>
            ...
            className='border border-[#000000] rounded text-[16px] font-normal p-[6px] pr-36 m-1' />
           <button className='border border-[#000000] rounded text-[14px] font-normal p-[7px] pl-[265px] md:pl-1 lg:pl-1 m-1 hover:bg-[#000000] hover:text-[#FFFFFF]'>Subscribe</button>
        </div>
        <div>
