  ...
  return (
    <section id="services" className='pt-8 pb-8 bg-[#F6F6F6]'>
        ...
        <div className='flex flex-col md:flex-row lg:flex-row justify-evenly'>
          ...
          <div className='pl-36 md:pl-16 lg:pl-16 pb-5 '>
          ...
          <div className='pl-5 text-center'>
            ...
            <ul className='flex pl-32 md:pl-11 lg:pl-11 pt-4 gap-1'>
          ...
          <div className='pl-36 md:pl-11 lg:pl-11 pb-5'>
          ...
          <div className='pl-5 text-center'>
           ...
           <div className='pt-12 hover:scale-105 transition-transform'>
           <div className='pl-36 md:pl-12 lg:pl-12 pb-5'>
